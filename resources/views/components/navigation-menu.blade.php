@props([
    'headerBgNavColor' => theme('header', 'bgColor'),
    'menuLinkClass' => theme('header', 'menuLinkClass'),
    'menuLinkClassMobile' => theme('header', 'responsiveNavClass'),
...
<nav x-data="{ open: false }" class="{{ $headerBgNavColor }} {{ $pageBorder }}">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a {{ when(config('saashovel.SPA_UX'), 'wire:navigate') }} href="{{ route('home') }}">
                        <x-application-mark />
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                @if ($menu && $menu->items)
                    @foreach ($menu->items as $item)
                        {!! \App\CustomRenderNavItem::render($item, $menuLinkClassMobile) !!}
                    @endforeach
                @endif
                <!-- /Blog menu code -->
                <!-- Team Management -->
