<x-pricing-section title="{{ __('Pricing Plans') }}" class="py-4">
    <x-pricing-plan
        ...
        :cta-action="route('checkoutLS', ['lemonsqueezyPriceId' => $plans['first-tier']['plan_id']])"
    />
    ...
    <x-pricing-plan
        ...
        :cta-btn-text="__('Choose Plan')"
        :cta-action="route('checkoutLS', ['lemonsqueezyPriceId' => $plans['second-tier']['plan_id']])"
    />
    ...
    <x-pricing-plan
        ...
        :cta-btn-text="__('Choose Plan')"
        :cta-action="route('checkoutLS', ['lemonsqueezyPriceId' => $plans['third-tier']['plan_id']])"
    />
</x-pricing-section>
